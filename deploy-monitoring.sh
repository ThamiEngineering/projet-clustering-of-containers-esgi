...
echo "  2. NPM -> nouveau Proxy Host : dozzle.thami.fr  -> dozzle:8080  (+ SSL Let's Encrypt)"
echo "     (recommandé : ajouter une Access List basic-auth sur dozzle.thami.fr)"
echo "  3. Login Grafana : admin / admin (changement de mot de passe au 1er login)"
echo "  4. Dashboards déjà provisionnés : Node Exporter Full, Docker Swarm Cluster Monitoring"
echo ""
